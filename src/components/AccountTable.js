...
function GlobalFilter({
  ...
  return (
    <label className="flex gap-x-2 items-baseline mt-4">
      ...
      <input
        type="text"
        className="px-2 py-2 rounded-xl bg-[#F3F4F6] border-gray-300 border-2 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
        value={value || ""}
        onChange={(e) => {
...
export function SelectColumnFilter({
  ...
  return (
    <label className="flex gap-x-2 items-baseline">
      ...
      <select
        className="rounded-xl bg-[#F3F4F6] border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 dark:bg-slate-700 dark:border-none"
        name={id}
        id={id}
        value={filterValue}
        onChange={(e) => {
...
function AccountTable({ columns, data }) {
        ...
        <div className="-my-2 overflow-x-auto -mx-4 sm:-mx-6 lg:-mx-8">
          <div className="py-2 align-middle inline-block min-w-full">
            <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
              ...
              >
                <thead className="bg-[#F7E6E6] text-black ">
                  {headerGroups.map((headerGroup) => (
                ...
                <tbody
                  {...getTableBodyProps()}
                  className="bg-white divide-y divide-gray-200 text-black tableboady"
                >
                  {page.map((row, i) => {
                    // new
                    prepareRow(row);
